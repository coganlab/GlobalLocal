...
def load_wavelets(sub: str, bids_root: str, epochs_root_file: str, rescaled: bool = False):
    """
    ...
    """
    if rescaled:
        filename = os.path.join(bids_root, 'BIDS', 'derivatives', 'spec', 'wavelet', sub, f'{epochs_root_file}_rescaled-tfr.h5')
    else:
        filename = os.path.join(bids_root, 'BIDS', 'derivatives', 'spec', 'wavelet', sub, f'{epochs_root_file}_uncorrected-tfr.h5')
