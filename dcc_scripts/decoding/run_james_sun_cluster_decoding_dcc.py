...
Should be wrapped in an sbatch script for cluster submission. TODO: Uh gemini says can't pass in a function as an argument. Is this right..? Check later.
TODO: Modify this to pass in the correct arguments to james_sun_cluster_decoding_dcc.py
"""
import sys
import os
import numpy as np
...
SUBJECTS = ['D0103']  # So need to manually update this, then run sbatch sbatch_get_sig_tfr_differences.sh. Not ideal, it would be better to have a submit script that loops over the subjects, but whatever!
