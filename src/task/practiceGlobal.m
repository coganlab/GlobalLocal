function [accuracy, exited] = practiceGlobal(windowPtr, fontDefault, maxWidth, maxHeight, ...
colorMapping, taskMapping, nTrials, iteration, fixInterval, stimInterval, subID, subjectDir, ifi)
    ...
    taskArr = createTaskArr(nTrials, 'g');
    ...
    while trial <= nTrials
        ...
        if paused 
            ...
            if paused
                ...
                writetable(out_data,strcat(subjectDir,'/GL_Global_Practice_Data_#',num2str(iteration),'_',subID,'_',time,'.csv'));
    ...
    function drawReminder()
        ...
        if colorMapping == 1
            ...
            %DrawFormattedText(windowPtr, 'Global', maxWidth/2 - 10, maxHeight / 2 + 345, [0 0 0], 100);
            DrawFormattedText(windowPtr, 'Big', maxWidth/2 - 10, maxHeight / 2 + 345, [0 0 0], 100);
