...
# Basal ganglia structures in FreeSurfer's aseg segmentation.
# (Striatum = caudate + putamen; pallidum = globus pallidus; plus accumbens.)
# STN is NOT in the standard aseg — see note below if you need it.
BG_ASEG_LABELS = {
    'lh': ['Left-Caudate', 'Left-Putamen', 'Left-Pallidum', 'Left-Accumbens-area'],
