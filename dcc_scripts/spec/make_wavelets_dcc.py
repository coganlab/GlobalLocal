...
good = get_good_data(subject, layout)

## epoching and trial outlier removal

save_dir = os.path.join(layout.root, 'derivatives', 'clean', subject)
...
for output_name, events in output_names_and_events_dict.items():
    spec = get_uncorrected_wavelets(subject, layout, events, signal_times)
