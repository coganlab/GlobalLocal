...
4. You can test your VPN access and download necessary antivirus: portal.duke.edu
...
5. On your local machine, open Microsoft Remote Desktop, click Add PC, and put in your full device name as the PC name. Put in your netid and netid password as your User account.
6. On your local machine, connect to Duke Health VPN. Wait a bit for it to let you through the firewall.
7. Now try connecting to your remote machine through Microsoft Remote Desktop by double-clicking the icon for it.
